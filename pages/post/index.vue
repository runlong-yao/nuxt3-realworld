        ...
        <template #default="{ list }">
          <div v-for="article in list"
            ...
            <div class="mt-1 text-gray-600 dark:text-gray-400 text-right">
              ...
              <AwesomeLink class="text-sm flex items-center justify-end space-x-1"
            ...
            <div class="flex flex-col">
              ...
              <div class="flex">
                <AwesomeLink class="text-sm flex space-x-1 items-center text-primary-500"
                  :to="article._path">
                  <span>learn more</span>
                  <Icon name="ic:baseline-arrow-right-alt"
                    class="text-sm" />
                </AwesomeLink>
              </div>
            </div>
